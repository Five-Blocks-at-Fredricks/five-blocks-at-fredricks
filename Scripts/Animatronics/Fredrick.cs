...
public partial class Fredrick : Node3D {
    ...
    private void MoveFredrick (
        ref int PositionNumber,
        ref Vector3 Pos,
        ref Vector3 Rot,
        ref Vector3 HeadRotation,
        ref Vector3 ArmOneRotation,
        ref Vector3 ArmTwoRotation,
        ref Vector3 LegOneRotation,
        ref Vector3 LegTwoRotation
    ) {
        if (PositionNumber == 0) {
            PositionNumber = 1;
